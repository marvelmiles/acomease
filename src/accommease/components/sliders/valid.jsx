...
import {
    ...
    CarouselIndicators,Card,CardImg,CardBody,
    CardText,CardTitle,Row,Col,Container,
    Form,Input,FormGroup,FormFeedback 
  ...
  >
   ...
   <div className=" banner-gallery-content" >
     ...
     <FormGroup className="banner-gallery-formGroup">
         <Input id="location-search" className="form-control-lg text-pri" placeholder="Find a lodge" />
...
<div className="flex-review-text">
    Taking the away hustle to get a nice place withh a nice pay rent...Your ease give us the desire to one do
    more.
  </div>
